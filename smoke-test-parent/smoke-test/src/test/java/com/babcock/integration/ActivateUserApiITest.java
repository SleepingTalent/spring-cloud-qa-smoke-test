...
public class ActivateUserApiITest {

    private static Logger logger = LoggerFactory.getLogger(ActivateUserApiITest.class);
    ...
    public void before() throws InterruptedException {
        waitForHelper.waitForService(userDomainApiUrl);
